(function(exports) {
	...
	if (typeof define === 'function' && define.amd) {
		debugger;
		define('reportService', ['../vendor/underscore.min.js', 'utilsService'], function() {
			//console.log('reportService define arguments', arguments);
			console.log('reportService define arguments _', typeof _);
			return reportService;
		});
	} else if (typeof exports !== 'undefined') {
		debugger;
		if (typeof module !== 'undefined' && module.exports) {
			exports.reportService = module.exports = reportService;
		}
